exports.templateResetPassword = (user, code, objectMessage) => {
  return `<!DOCTYPE html>
    <html lang="en">
    <head>
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    Please click on the following link, or paste this into your browser to complete the process:
                     ...
                     http://localhost:4000/api/reset-password/${code}
                    <!-- Action -->
                            ...
                            <tr>
                              <td align="center">
                                <table border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td>
                                      <a href="http://localhost:8000/api/v1/confirmation/${code}" class="button button--yellow" style="color:#413F3F;padding:5px;font-weight:bold;border-radius:10px; font-size:16px;" target="_blank" type="submit">Password change request.</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
